...
export interface Change {
     ...
     * on whether this change is a rename change.
     * When in doubt always use `uri` over the other two alternatives.
     */
    readonly uri: Uri;
...
export interface Repository {
    ...
    getBranches(query: { remote?: boolean; }, cancellationToken?: CancellationToken): Promise<Ref[]>;
...
export interface GitExtension {
     ...
     * Throws error if git extension is disabled.
     *
